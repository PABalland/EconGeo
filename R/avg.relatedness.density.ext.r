...
#'
#' ## run the function
#' avg.relatedness.density.ext (mat, relatedness)
#' @author Pierre-Alexandre Balland \email{p.balland@uu.nl}
#' @seealso \code{\link{relatedness}}, \code{\link{relatedness.density}}, \code{\link{relatedness.density.ext}}, \code{\link{relatedness.density.int}}, \code{\link{avg.relatedness.density.int}}
...
"avg.relatedness.density.ext" <- function(mat, relatedness) {
...
reldensext <- (rowSums (reldens * mat, na.rm = T) / rowSums (mat, na.rm = T))

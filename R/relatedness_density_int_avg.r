...
#' @seealso \code{\link{relatedness}}, \code{\link{relatedness_density}}, \code{\link{relatedness_density_ext}}, \code{\link{relatedness_density_int}}, \code{\link{relatedness_density_ext_avg}},
...
relatedness_density_int_avg <- function(mat, relatedness) {
  ...
  reldensint <- round((rowSums(reldens * mat, na.rm = TRUE) /

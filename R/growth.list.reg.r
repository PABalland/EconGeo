...
"growth.list.reg" <- function(mat1, mat2, mat3, mat4, mat5, mat6, mat7, mat8, mat9, mat10, mat11, mat12, mat13, mat14, mat15, mat16, mat17, mat18, mat19, mat20) {
...
growth = ((rowSums(bim2) - rowSums(bim1))/rowSums(bim1))*100
growth[is.nan(growth)] <- 0
growth = round (growth, digits = 2)

growth = data.frame (region = rownames (mat1), gr.reg = growth)
growth$period <- n
...
growth2 = ((rowSums(bim2) - rowSums(bim1))/rowSums(bim1))*100
growth2[is.nan(growth2)] <- 0
growth2 = round (growth2, digits = 2)

growth2 = data.frame (region = rownames (mat1), gr.reg = growth2)
growth2$period <- n

...
#' @return A vector of industrial growth by regions from two regions - industries matrices
#' @keywords growth
#' @export
#' @examples
...
growth_reg <- function(mat1, mat2) {
  growth <- ((rowSums(mat2) - rowSums(mat1)) / rowSums(mat1)) * 100

...
"growth.list" <- function(mat1, mat2, mat3, mat4, mat5, mat6, mat7, mat8, mat9, mat10, mat11, mat12, mat13, mat14, mat15, mat16, mat17, mat18, mat19, mat20) {
...
growth2 = ((bim2 - bim1)/bim1)*100
growth2[is.nan(growth2)] <- 0

growth2 = get.list (growth2)
colnames (growth2) <- c("region", "industry", "growth")
growth2$period <- n
